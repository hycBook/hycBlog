...
function e(t, n, r) {
    ...
    12 : [function(e, t, n) {
        ...
        async function run(){
            ...
            await sleep(3000);
            loadlive2d("model_1", `https://cdn.jsdelivr.net/gh/zztongtong/moc-models@4.0/rem/model.json`, null);
            console.log('成功加载2d模型');
        }
        async function run_valine(){
            // naruthyc: 页面刷新时，重新加载2D模型
            await sleep(3000);
            new Valine({el: "#vcomments",appId: 'evyLlP61gQN3G3OM2GQq1rzH-gzGzoHsz',appKey: 'utUrzoiqNaDEGlgr09JL1pXB',placeholder: '欢迎留下评论交流~',avatar: 'wavatar',meta: undefined,pageSize: 15,lang: 'zh-CN',recordIP: false,
                               visitor: true,
                // 阅读量统计
                emojiMaps: {
