...
<center><img src="res/14.python基础知识/v2-0d0285e7b9433eeedf7e705d6e082d13_720w.jpg" width=400></center>
...
<img src="res/14.python基础知识/20170516000644044.png" width=500>
...
* 伪随机数: 采用梅森旋转算法生成的(伪)随机序列中元素
  ...
  <img src="res/14.python基础知识/1568510165657.png" width=500/>
...
![img](res/14.python基础知识/kuangstudy46bdad36-d3e0-43b0-a223-43360b7e8fc7.png)

反向代理

![img](res/14.python基础知识/kuangstudy62a15097-6e2a-4dbe-bcf5-f0d7cab81089.png)
...
![img](res/14.python基础知识/kuangstudyb1e3e440-4159-4259-a174-528b56cb04b2.png)

#### iphash

对客户端请求的ip进行hash操作，然后根据hash结果将同一个客户端ip的请求分发给同一台服务器进行处理，可以解决session不共享的问题。

![img](res/14.python基础知识/kuangstudy64acb9a3-cd1a-4c0e-a1fa-9b220046a95a.png)
...
![img](res/14.python基础知识/kuangstudyedb1bbd6-e530-4aba-8fde-68658a10e73f.png)
...
![img](res/14.python基础知识/kuangstudyf23105c4-b0b2-4e22-a1bf-b8098f40c144.png)
