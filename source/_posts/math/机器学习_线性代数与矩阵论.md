...
对于向量$x_1 = \left[ \begin{matrix} 1 & 2 & 3 \end{matrix} \right] \qquad x_2 = \left[ \begin{matrix} 1 & 0 & 1 \end{matrix} \right]$

其格拉姆矩阵为$ G = \left[ \begin{matrix} x_1^Tx_1 & x_1^Tx_2 \\ x_2^Tx_1 & x_2^Tx_2 \end{matrix} \right] = \left[ \begin{matrix} 14 & 4 \\ 4 & 2 \end{matrix} \right]$
