...
使用设计模式的目的：为了代码可重用性、让代码更容易被他人理解、保证代码可靠性
 ...
 设计模式使代码编写真正工程化；设计模式是[软件工程](https://baike.baidu.com/item/软件工程/25279)的基石脉络，如同大厦的结构一样
...
| **Type**            | **Symbol** | **Drawing**                                                  |
| ------------------- | ---------- | ------------------------------------------------------------ |
| Extension（扩展）   | <&#124;--  | ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/extends01.webp) |
| Composition（组合） | *--        | ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/sym03.webp) |
| Aggregation（聚合） | o--        | ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/sym01.webp) |
...
![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/class-diagram-cezra8kp.webp)
```json
@startuml 
Class11 <|.. Class12 
Class13 --> Class14 
...
| ------------- | :----------------------------------------------------------: | :---------------------------------------------: | --------------- |
| `-`           | ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/private-field.webp) |     ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/private-method.webp)     | private         |
| `#`           | ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/protected-field.webp) |    ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/protected-method.webp)    | protected       |
| `~`           | ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/package-private-field.webp) | ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/package-private-method.webp) | package private |
| `+`           |            ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/public-field.webp)             |     ![img](https://pic.hycbook.com/i/hexo/bk_resources/java/设计模式/public-method.webp)      | public          |
