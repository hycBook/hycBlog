...
* 找到`Internet信息服务`，并选中`FTP服务`、`FTP扩展性`和`IIS管理控制台`前的复选框，点击确定
  ...
  <center><img src="res/2.reinstall_the_system/image-20220209142702157.png" width=400></img></center>
...
* 开始配置，选择`无SSL`
  ...
  <center><img src="res/2.reinstall_the_system/020914194547_011111.png" width=700></img></center>
