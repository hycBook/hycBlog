...
sudo rpm -ivh --prefix=/home/nebula nebula-graph-3.2.1.el7.x86_64.rpm
```
...
使用命令`arch`，查看系统结构，去[官网](https://github.com/vesoft-inc/nebula-console/releases)下载安装包，重命名文件为`nebula-console`
